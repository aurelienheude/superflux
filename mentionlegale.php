<div class="legalMentionColumn">
        <p>
            ...
            <br>
            <br>
            Ce site est édité par la société <strong>Superflux</strong>.
            <br>
            Siège social : <strong>Superflux</strong>, 10 Place Léon Meyer, 76600 Le Havre France. 3eme etage, premier bureaux, ceux a gauche.<br>
            Capital social : 125.550 euros<br>
            Téléphone : +06XXXXXXXXXX<br>
            <br>
            Responsable de la rédaction : HEUDE Aurélien<br>
            <br>
        ...
        <div class="text-center">
            ...
            société
            <strong>Superflux</strong>.<br>
            <br>
            Elles ne font l'objet d'aucune cession à des tiers. <strong>All In
                Bagels</strong> traite les informations qui vous
            concernent
            avec
            ...
            propriété
            de
            la société Superflux, il est protégé par les lois en vigueur de la législation française sur la propriété
            intellectuelle.<br>
            <br>
            ...
            utiliser
            ce
            site. Superflux ne saurait être tenu responsable des éléments en dehors de son contrôle et des dommages
            qui
            ...
            <br>
            <strong>Superflux</strong> s'attache à transmettre des informations
            ...
            la
            responsabilité de Superflux.<br>
            De même que la société <strong>Superflux</strong> ne pourra en aucune façon
